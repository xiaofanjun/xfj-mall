package com.xfj.user.kafkaConfig;

import com.xfj.user.registerVerification.KafKaRegisterSuccConsumerFactory;
import com.xfj.user.registerVerification.KafKaRegisterSuccProducerFactory;
...
/**
 * @Author ZQ
 * @Description 这种方式可以很灵活的添加多个生产者工厂；
...
public class KafKaConfig {
    ...
    public KafKaRegisterSuccConsumerFactory kafKaRegisterSuccConsumerFactory() {
        ...
        consumerProperties.put("spring.json.trusted.packages", "com.xfj.user.dal.entitys,com.xfj.user.dal.*");
        /*
