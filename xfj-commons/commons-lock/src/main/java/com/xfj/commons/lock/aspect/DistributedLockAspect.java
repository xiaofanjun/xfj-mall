package com.xfj.commons.lock.aspect;

import com.xfj.commons.lock.DistributedLock;
import com.xfj.commons.lock.annotation.CustomerLock;
import com.xfj.commons.lock.extension.ExtensionLoader;
...
public class DistributedLockAspect {
    ...
    //切入点：有这个注解的方法
    @Pointcut("@annotation(com.xfj.commons.lock.annotation.CustomerLock)")
    ...
    private Object startLock(final String lockKey, ProceedingJoinPoint pjp, Method method) throws Throwable {
        ...
        //是否尝试获得锁 com.xfj.commons.lock.annotation.CustomerLock.tryLock
